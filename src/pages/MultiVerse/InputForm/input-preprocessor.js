class InputPreprocessor {
  ...
  static process(input) {
    const hint = null;
    const lines = InputPreprocessor.normalizeText(input);
    const wordCount = InputPreprocessor.wordCount(lines);
    ...
    // if (m1WordCount === 0) {
    //   firstMesra = Array(m2WordCount + 1)
    //     .join(' ؟')
    //     .trim();
    //   m1WordCount = m2WordCount;
    // }
    // if (m2WordCount === 0) {
    //   secondMesra = Array(m1WordCount + 1)
    //     .join(' ؟')
    //     .trim();
    ...
    //   if (m1WordCount < 3) {
    //     firstMesra = `${firstMesra} ${Array(4 - m1WordCount)
    //       .join(' ؟')
    //       .trim()}`;
    //   }
    //   if (m2WordCount < 3 && m2WordCount > 0) {
    //     secondMesra = `${secondMesra} ${Array(4 - m2WordCount)
    //       .join(' ؟')
    //       .trim()}`;
    //   }
    ...
    //   hint =
    //     'یک مصرع بطور معمول بین سه تا ده کلمه است. برای گرفتن نتیجه بهتر طول مصرع را کوتاه کنید. ';
