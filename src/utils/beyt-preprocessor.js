export default class BeytPreprocessor {
  ...
  static process(firstMesraText, secondMesraText) {
    let hint = null;
    let firstMesra = BeytPreprocessor.normalizeText(firstMesraText);
    let secondMesra = BeytPreprocessor.normalizeText(secondMesraText);
    let m1WordCount = BeytPreprocessor.wordCount(firstMesra);
    let m2WordCount = BeytPreprocessor.wordCount(secondMesra);
